...
namespace PampelGames.GoreSimulator.Editor
{
    internal static class BonesClassEditorInit
    {
        ...
        public static bool VerifyFillBonesClasses(GoreSimulator _goreSimulator)
        {
            ...
            if (!_goreSimulator.smr.sharedMesh.isReadable)
            {
                EditorUtility.DisplayDialog("Mesh not readable", "Please set Read/Write to enabled in the character fbx file.", "Ok");
                return false;
            }
        ...
        public static bool FillBonesClasses(GoreSimulator _goreSimulator, Mesh bakedMesh)
        {
            ...
            meshNativeDataClass.InitializeRuntimeMeshData(bakedMesh, indexes);
            ...
            for (var i = 0; i < bonesClasses.Count; i++)
            {
                ...
                for (var j = 0; j < bonesStorageClass.cutIndexClasses.Count; j++)
                {
                    ...
                    MeshCutJobs.IndexesSnapshotCut(meshNativeDataClass, bakedMesh, executionCutClass, explosionMesh);
