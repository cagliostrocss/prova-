...
namespace PampelGames.GoreSimulator
{
    public static class BonesUtility
    {
        ...
        public static List<Transform> GetChildren(HashSet<Transform> smrBones, Transform bone, Enums.Children childrenEnum, List<Transform> fixedChildren)
        {
            var children = new List<Transform>();
            if(childrenEnum != Enums.Children.None) GetChildrenIteration(smrBones, bone, children, childrenEnum);
            children.RemoveAll(fixedChildren.Contains);
