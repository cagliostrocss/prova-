...
namespace PampelGames.GoreSimulator
{
    public class GoreMultiCut : MonoBehaviour, IGoreObjectParent
    {
        ...
        private void CreateChildObjects()
        {
            ...
            var _bakedMesh = new Mesh();
            childRenderer.BakeMesh(_bakedMesh);
            var bakedVertices = PGMeshUtility.CreateVertexList(_bakedMesh);
            var bakedNormals = new List<Vector3>(bakedVertices.Count);
            _bakedMesh.GetNormals(bakedNormals);
            ...
            {
                MeshCutJobs.IndexesSnapshotExplosion(transform, multiCutChildClass.chunkClass, bakedVertices, bakedNormals);
