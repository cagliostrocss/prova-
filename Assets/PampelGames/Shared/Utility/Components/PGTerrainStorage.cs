...
namespace PampelGames.Shared.Utility
{
    ...
    public class PGTerrainStorage : MonoBehaviour
    {
        ...
        public bool resetOnExitPlayMode;
        ...
        {
#if UNITY_EDITOR
            if (resetOnExitPlayMode) EditorApplication.playModeStateChanged += OnPlayModeChanged;
#endif
        }
        ...
        private void OnPlayModeChanged(PlayModeStateChange state)
        {
            if (state == PlayModeStateChange.EnteredEditMode)
            {
                ...
                if (resetOnExitPlayMode) SetTerrainData();
            }
        }
#endif
    }
    ...
    public class PGTerrainStorageInspector : Editor
    {
        ...
        private Toggle resetOnExitPlayMode;
        ...
        private void BindElements()
        {
            ...
            resetOnExitPlayMode = new Toggle("Reset On Exit Play Mode");
            resetOnExitPlayMode.style.marginTop = 10;
            resetOnExitPlayMode.tooltip = "If checked, the terrain will be reset to the last serialized data when exiting play mode.";
            resetOnExitPlayMode.BindProperty(serializedObject.FindProperty(nameof(resetOnExitPlayMode)));
        }
        ...
        private void AddElements()
        {
            ...
            container.Add(resetOnExitPlayMode);
        }
